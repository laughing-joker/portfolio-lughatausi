 import aboutImg1 from "../assets/images/h.jpg"; 
 import aboutImg2 from "../assets/images/g.jpg"; 
 import aboutImg from "../assets/images/f.jpg";
 import { ABOUT_TEXT } from "../constants"; 
 import {ABOUT_ME} from "../constants"; 
 import {ABOUT_MI} from '../constants';
  ...
  return (
    <div className="border-b border-neutral-900 pb-4">
      ...
      <div className="flex flex-wrap">
        <motion.div whileInView={{opacity:1, x:0}} initial={{opacity:0, x:-100}} transition={{duration:0.5}} className="w-full lg:w-1/2 lg:p-8">
          <div className="flex items-center justify-center">
            <img className="rounded-2xl" src={aboutImg1} alt="About Image" />
          </div>
      ...
      <div className="flex flex-wrap">
        <motion.div whileInView={{opacity:1, x:0}} initial={{opacity:0, x:-100}} transition={{duration:0.5}} className="w-full lg:w-1/2 lg:p-8">
          <div className="flex items-center justify-center">
            <img className="rounded-2xl" src={aboutImg2} alt="About Image" />
          </div>
